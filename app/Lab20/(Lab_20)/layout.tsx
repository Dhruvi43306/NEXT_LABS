...
import { Home, User, Info, Database, Layers, Command, Bell, Search, Sparkles, Layout,ArrowLeft, Contact } from "lucide-react";
        ...
        <div className="flex min-h-screen p-4 lg:p-6 gap-6">
          ...
          <aside className="hidden lg:flex w-24 flex-col bg-white/60 backdrop-blur-2xl rounded-[2.5rem] p-5 transition-all duration-500 hover:w-64 group shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] border border-white/80 sticky top-6 h-[calc(100vh-3rem)]">
            ...
            <nav className="flex flex-col gap-2">
              <NavLink href="/Lab20/home" icon={<Home size={20}/>} label="Home" color="blue" vertical />
              <NavLink href="/Lab20/contact" icon={<User size={20}/>} label="Contact" color="rose" vertical />
              <NavLink href="/Lab20/about" icon={<Info size={20}/>} label="About" color="amber" vertical />
            </nav>
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <header className="h-20 bg-white/70 backdrop-blur-xl border border-white/80 rounded-3xl shadow-sm px-8 flex items-center justify-between">
              ...
              <nav className="hidden xl:flex items-center gap-1 bg-slate-900/5 p-1 rounded-2xl border border-slate-900/5">
               <NavLink href="/Lab20/home" icon={<Layers size={16}/>} label="HOME" color="indigo" />
              <NavLink href="/Lab20/about" icon={<Database size={16}/>} label="ABOUT" color="rose" />
               <NavLink href="/Lab20/about" icon={<Contact size={16}/>} label="Contact" color="emerald" />
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 ml-2 border-l pl-6 border-slate-200">
                  ...
                  <div className="w-11 h-11 rounded-2xl bg-gradient-to-tr from-slate-800 to-slate-950 border-2 border-white shadow-lg flex items-center justify-center text-white font-black text-xs">
                    DS
                  </div>
                </div>
              </div>
