        ...
        <div className="flex min-h-screen p-4 lg:p-6 gap-6">
          ...
          <aside className="hidden lg:flex w-24 flex-col bg-white/60 backdrop-blur-2xl rounded-[2.5rem] p-5 transition-all duration-500 hover:w-64 group shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] border border-white/80 sticky top-6 h-[calc(100vh-3rem)]">
            ...
            <nav className="flex flex-col gap-2">
              <NavLink href="/Lab22/Lab_22/dashboard/admin" icon={<LayoutDashboard size={20}/>} label="Admin" color="blue" vertical />
              <NavLink href="/Lab22/Lab_22/fullDashboard/manager" icon={<LayoutDashboardIcon size={20}/>} label="Manager" color="rose" vertical />
              <NavLink href="/Lab22/Lab_22/fullDashboard/d2" icon={<User size={20}/>} label="User" color="amber" vertical />
            </nav>
          ...
          <div className="flex-1 flex flex-col gap-6">
            ...
            <header className="h-20 bg-white/70 backdrop-blur-xl border border-white/80 rounded-3xl shadow-sm px-8 flex items-center justify-between">
              ...
              <nav className="hidden xl:flex items-center gap-1 bg-slate-900/5 p-1 rounded-2xl border border-slate-900/5">
                <NavLink href="/Lab22/Lab_22/dashboard/admin/profile/1" label="Admin Profile" icon={<Ticket size={19} />} color="emerald" />
                <NavLink href="/Lab22/Lab_22/fullDashboard/manager/profile/2" label="Manager Profile" icon={<Ticket size={19} />} color="emerald" />
                <NavLink href="/Lab22/Lab_22/fullDashboard/d2/profile/3" label="Member Profile" icon={<User size={19} />} color="pink" ></NavLink>
                </nav>
